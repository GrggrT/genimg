...
try:
    ...
    messagebox.showerror("Ошибка импорта", "team_mappings_fixed.py не найден.")
    TEAM_MAPPINGS = {}
...
def create_main_gui(on_generate_callback):
    # ... (вставьте сюда полный код функции create_main_gui из моего предыдущего ответа) ...
    # Он уже был правильным
    root = tk.Tk(); root.title("Генератор постов v0.4"); root.geometry("700x850")
    # ... весь остальной код GUI, который мы разработали ...
    ...
    single_post_frame = ttk.Frame(input_forms_container, padding="10"); express_post_frame = ttk.Frame(input_forms_container, padding="10")
